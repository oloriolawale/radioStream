...
var api = 'http://monarchriseradio.com/api/';
var useAuth = true;
var showWalkthrough = false;
var showOfflineMessage = true;
var blockIfOffline = true;

angular.module('roots', ['ionic', 'roots.controllers', 'roots.services', 'angularMoment', 'ngMap', 'ngCordova', 'ngWebAudio', 'ionic-audio', 'ion_audio_directive'])
